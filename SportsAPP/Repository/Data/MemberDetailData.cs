...
namespace SportsAPP.Repository.Data
{
    public class MemberDetailData
    {
        ...
        public List<dynamic> AddMember(MemberDetails Member)
        {
            ...
            input_parameters.Add("@date_of_birth", 1 + "#datetime#" + now);
            ...
            input_parameters.Add("@cheque_date", 1 + "#datetime#" + now);
            ...
            input_parameters.Add("@CorresAddr", 1 + "#bit#" + Member.CorresAddr);
        ...
        public List<dynamic> GetMemberData(Int64 id)
        {
            ...
            input_parameters.Add("@pkey_member_id", 1 + "#bigint#" + id);
             ...
             List<MemberDetails> ordtl =
               (from item in myEnumerable
                select new MemberDetails
                {
                    ...
                    cheque_date=item.Field<String>("cheque_date"),
                    ...
                    //CorresAddr=item.Field<Boolean>("CorresAddr"),
